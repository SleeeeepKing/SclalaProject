...
object Test2 {
  ...
  val edges3: Set[Edge[Int]] = Set(Edge(1, 4),Edge(4, 6),Edge(2, 5),Edge(3,5))
  val g = new SimpleGraphDefaultImpl[Int](vertices, edges3)
...
//    println(edges2.find(_._2 == 5))
    println(g.hasPath(1,2))
